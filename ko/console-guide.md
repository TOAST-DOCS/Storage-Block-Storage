...
인스턴스가 실행 중인 상태에서도 블록 스토리지를 연결 해제할 수 있습니다. 단, 먼저 인스턴스에서 블록 스토리지를 마운트 해제하고 콘솔에서 블록 스토리지 연결을 해제합니다. 블록 스토리지가 마운트 된 상태에서 연결 해제하면 아래와 같은 문제가 발생합니다.

1. 블록 스토리지 데이터에 손상이 생겨서 데이터가 유실될 수 있습니다.
2. 블록 스토리지를 새로 추가할 경우 콘솔에서 보이는 블록 스토리지 이름과 인스턴스에서 보이는 블록 스토리지의 이름이 다르게 보입니다. 다만, 인스턴스를 재시작하면 콘솔과 인스턴스에서 동일한 블록 스토리지 이름을 사용합니다.
