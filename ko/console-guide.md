...
생성한 블록 스토리지를 다른 리전으로 복사하여 이용할 수 있습니다. 블록 스토리지가 인스턴스에 연결되어 있는 상태에서도 복사할 수 있지만, 데이터의 정합성과 안정성을 보장하기 위해 인스턴스를 종료하거나 연결을 해제하고 복사하기를 권장합니다.

콘솔에서 [다른 리전으로 복사]를 클릭하여 복사할 대상 리전을 선택 후 복사할 수 있습니다. 복사 기능은 일회성이며 그 이후 원본 블록 스토리지에 대한 변동사항은 반영되지 않습니다.
