...
```
# echo "UUID=5a4004f4-3ba6-4484-9459-7c2b321b727f /mnt/vdb xfs defaults,nodev,noatime,nobootwait 1 2" >> /etc/fstab
```

> [참고] 위 예제에서는 볼륨 마운트에 실패하더라도 부팅이 될 수 있도록 `nobootwait` 옵션을 추가하였습니다.
...
do
   ...
   echo "UUID=$UUID $MOUNT_DIR $FS_TYPE defaults,nodev,noatime,nobootwait 1 2" >> /etc/fstab
