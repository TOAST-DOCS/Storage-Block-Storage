...
1. [블록 스토리지를 생성](/Storage/Block%20Storage/ko/console-guide-gov/#create-block-storage)합니다.
2. 생성한 블록 스토리지를 [대상 인스턴스에 연결](/Storage/Block%20Storage/ko/console-guide-gov/#attach-block-storage)합니다.
