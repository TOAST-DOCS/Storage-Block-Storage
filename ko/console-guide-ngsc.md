...
이러한 상황을 방지하기 위하여 추가 블록 스토리지를 `/etc/fstab`에 등록할 경우에는 [블록 스토리지 마운트 가이드](/Storage/Block%20Storage/ko/overview-ngsc/#mount-block-storage)에 따라 `nofail` 옵션을 사용하는 것을 권장합니다.
